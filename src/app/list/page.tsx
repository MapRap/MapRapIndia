                ...
                if (item.property === "Residential") {
                  return (
                    <AccordionItem key={item.area} value={`${item.area}`}>
                      <AccordionTrigger className="p-0 m-0  bg-black md:bg-transparent opacity-70 md:opacity-100">
                        <h1 className="font-bold flex justify-center text-center text-3xl w-full text-white m-0 hover:underline md:opacity-80">
