    ...
    <div className="flex flex-col items-center m-2">
      ...
      <div className="w-4/5 text-slate-600">
        <div>
          ...
          visit, use our services, or make a purchase from MapRap.com {`(`}the
          {` "`}Site{`"`}
          {`)`} or otherwise communicate with us regarding the Site {`(`}
          collectively, the {`"`}Services{`"`}
          {`)`}. For purposes of this Privacy Policy, {`"`}you{`"`} and {`"`}
          your
          {`"`} means you as the user of the Services, whether you are a
          customer, website visitor, or another individual whose information we
          have collected pursuant to this Privacy Policy. Please read this
          Privacy Policy carefully. By using and accessing any of the Services,
        ...
        <div>
          ...
          <div>
            ...
            term {`"`}personal information{`"`}, we are referring to information
        ...
        <div>
          ...
          <div className="text-center ">
            ...
            <strong className="italic">Third Party Websites and Links.</strong>
          </div>
        </div>
        <div>
          <div className="font-bold text-lg text-black text-center">
        ...
        <div>
          ...
          <div>
            Like many websites, we use Cookies on our Site. see . We use Cookies
          ...
          <div className="text-center ">
            ...
            <ul className="w-3/4 text-start">
              <li>
                ...
                behalf {`(`}e.g., IT management, payment processing, data
            ...
            <div className="flex justify-center flex-row">
              <div className="flex-1 border-gray-200 border-2">
                <div className=" font-bold text-slate-800 border-gray-200 border-2">
                  Category
                </div>
                <div className="m-3 ">
              ...
              <div className="flex-1 border-gray-200 border-2">
                <div className="font-bold border-gray-200 border-2 text-slate-800">
                  Categories of Recipents
                </div>
                <div className="items-center justify-center">
                  <div className="m-3 ">
                    Vendors and third parties who perform services on our behalf
                    {` (`}such as Internet service providers, payment
                    processors, fulfillment partners, customer support partners
                    and data analytics providers{`)`}
                  </div>
                  <div className="m-3 ">Business and marketing partners</div>
                  <div className="m-3 ">Affiliates</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mt-4">
            <ul className="m-4">
              <li>
                <strong className="text-black">Right to Access / Know:</strong>{" "}
              ...
              <li>
                <strong className="text-black">Right to Delete:</strong> You may
                have a right to request that we delete personal information we
                maintain about you.
              </li>
              <li>
                <strong className="text-black">Right to Correct:</strong> You
                may have a right to request that we correct inaccurate personal
                information we maintain about you.
              </li>
              <li>
                <strong className="text-black">Right of Portability:</strong>{" "}
              ...
              <li>
                <strong className="text-black">Withdrawal of Consent:</strong>{" "}
                Where we rely on consent to process your personal information,
                you may have the right to withdraw this consent.
              </li>
              <li>
                <strong className="text-black">Appeal:</strong> You may have a
                right to appeal our decision if we decline to process your
        ...
        <div>
          ...
          <div>
            ...
            available to you, please call or email us at maprapindia@gmail.com
            or contact us at <br /> Building No./Flat No.: H.NO.95/1, TRIKUTA
            NAGAR
            <br />
            Road/Street: H.NO.95/1, TRIKUTA NAGAR
            <br />
            Nearby Landmark: Kay Tea Designer Studio
            <br />
            City/Town/Village: Jammu
            <br />
            District: Jammu
            <br />
            State: Jammu And Kashmir,PIN Code: 180020, IN.
          </div>
        </div>
      </div>
    </div>
