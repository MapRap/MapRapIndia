...
import { uploadInteriorDesignPdf } from "@/_actions/uploadInteriorDesignPdf";

const { useUploadThing } = generateReactHelpers<OurFileRouter>();
export const InteriorPdfUploadForm = ({ jobId }: { jobId: string }) => {
  console.log(jobId);
      ...
      {isUploaded && pdfUrl && (
        <div style={{ marginTop: "20px" }}>
          ...
          <div style={{ marginTop: "10px" }}>
            ...
            <Button
              onClick={() => {
                uploadInteriorDesignPdf({ link: pdfUrl, id: jobId }).then(
                  (e) => {
                    // console.log(e);
                    if (!e) {
